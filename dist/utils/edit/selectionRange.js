...
function setSelectionRange(element, newSelectionStart, newSelectionEnd) {
  ...
  if (selection && // Skip setting the range for <input> and <textarea> because
  // the parent <div> will be selected.
  !(0, _isElementType.isElementType)(element, 'input') && !(0, _isElementType.isElementType)(element, 'textarea')) {
